...
Units can be added _power prefixes_. You must know nano up to giga.Careful with time above seconds! (not x10)
...
* **Graphs:** 
    ...
    - Line equation: $y = ax + b$, $b$ is the gradient or slope.
